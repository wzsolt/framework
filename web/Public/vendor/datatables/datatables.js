 ...
 *   https://datatables.net/download/#bs4/dt-1.10.22/fh-3.1.7/r-2.2.6/rg-1.1.2/sc-2.0.3/sp-1.2.0
 *
 * Included libraries:
 *   DataTables 1.10.22, FixedHeader 3.1.7, Responsive 2.2.6, RowGroup 1.1.2, Scroller 2.0.3, SearchPanes 1.2.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.22/fh-3.1.7/r-2.2.6/rg-1.1.2/sc-2.0.3/sp-1.2.0",
