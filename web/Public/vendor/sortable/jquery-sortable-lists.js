		...
		return this.on( 'mousedown', function( e )
			{
				...
				if ( state.isDragged !== false || ( setting.ignoreClass && (target.hasClass( setting.ignoreClass ) || target.parents().hasClass( setting.ignoreClass )) ) ) return; // setting.ignoreClass is checked cause hasClass('') returns true
