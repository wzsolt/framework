...
class VideoUrlParser
{
    ...
    public static function get_url_watch($url)
    {
        $service = self::identify_service($url);
        ...
        if ($service == 'youtube') {
            return self::get_youtube_watch($id);
        } elseif ($service == 'vimeo') {
            return self::get_vimeo_watch($id);
        }
        return null;
    }
     ...
     */
    public static function get_youtube_embed($youtube_video_id, $autoplay = false)
    {
        return "https://youtube.com/embed/$youtube_video_id" . ($autoplay ? "?autoplay=1" : "");
    }

    public static function get_youtube_watch($youtube_video_id)
    {
        return "https://youtube.com/watch?v=" . $youtube_video_id;
    }
     ...
     * @return string the embed url
     */
    public static function get_vimeo_embed($vimeo_video_id, $autoplay = false)
    {
        return "https://player.vimeo.com/video/$vimeo_video_id?byline=0&amp;portrait=0&amp;" . ($autoplay ? ";autoplay=1" : "");
    }

    public static function get_vimeo_watch($vimeo_video_id)
    {
